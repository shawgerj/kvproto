...
func (*BatchCommandsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_cfafee8e4a43078c, []int{0}
}
...
type BatchCommandsRequest_Request struct {
	...
	//	*BatchCommandsRequest_Request_RawPrintStats
...
func (*BatchCommandsRequest_Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_cfafee8e4a43078c, []int{0, 0}
}
...
type BatchCommandsRequest_Request_RawPrintStats struct {
	RawPrintStats *kvrpcpb.RawPrintStatsRequest `protobuf:"bytes,27,opt,name=RawPrintStats,oneof"`
}
...
func (*BatchCommandsRequest_Request_RawPrintStats) isBatchCommandsRequest_Request_Cmd()       {}
...
func (m *BatchCommandsRequest_Request) GetRawPrintStats() *kvrpcpb.RawPrintStatsRequest {
	if x, ok := m.GetCmd().(*BatchCommandsRequest_Request_RawPrintStats); ok {
		return x.RawPrintStats
	}
	return nil
}
...
func (*BatchCommandsRequest_Request) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _BatchCommandsRequest_Request_OneofMarshaler, _BatchCommandsRequest_Request_OneofUnmarshaler, _BatchCommandsRequest_Request_OneofSizer, []interface{}{
		...
		(*BatchCommandsRequest_Request_RawPrintStats)(nil),
...
func _BatchCommandsRequest_Request_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *BatchCommandsRequest_Request_RawPrintStats:
		_ = b.EncodeVarint(27<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RawPrintStats); err != nil {
			return err
		}
...
func _BatchCommandsRequest_Request_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 26: // cmd.TxnHeartBeat
		...
		return true, err
	case 27: // cmd.RawPrintStats
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(kvrpcpb.RawPrintStatsRequest)
		err := b.DecodeMessage(msg)
		m.Cmd = &BatchCommandsRequest_Request_RawPrintStats{msg}
		return true, err
...
func (*BatchCommandsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_cfafee8e4a43078c, []int{1}
}
...
type BatchCommandsResponse_Response struct {
	...
	//	*BatchCommandsResponse_Response_RawPrintStats
...
func (*BatchCommandsResponse_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_cfafee8e4a43078c, []int{1, 0}
}
...
type BatchCommandsResponse_Response_RawPrintStats struct {
	RawPrintStats *kvrpcpb.RawPrintStatsResponse `protobuf:"bytes,27,opt,name=RawPrintStats,oneof"`
}
...
func (*BatchCommandsResponse_Response_RawPrintStats) isBatchCommandsResponse_Response_Cmd()       {}
...
func (m *BatchCommandsResponse_Response) GetRawPrintStats() *kvrpcpb.RawPrintStatsResponse {
	if x, ok := m.GetCmd().(*BatchCommandsResponse_Response_RawPrintStats); ok {
		return x.RawPrintStats
	}
	return nil
}
...
func (*BatchCommandsResponse_Response) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _BatchCommandsResponse_Response_OneofMarshaler, _BatchCommandsResponse_Response_OneofUnmarshaler, _BatchCommandsResponse_Response_OneofSizer, []interface{}{
		...
		(*BatchCommandsResponse_Response_RawPrintStats)(nil),
...
func _BatchCommandsResponse_Response_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *BatchCommandsResponse_Response_RawPrintStats:
		_ = b.EncodeVarint(27<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RawPrintStats); err != nil {
			return err
		}
...
func _BatchCommandsResponse_Response_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 27: // cmd.RawPrintStats
		...
		msg := new(kvrpcpb.RawPrintStatsResponse)
		err := b.DecodeMessage(msg)
		m.Cmd = &BatchCommandsResponse_Response_RawPrintStats{msg}
		return true, err
	case 33: // cmd.CheckSecondaryLocks
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
...
func (*BatchRaftMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_cfafee8e4a43078c, []int{2}
}
...
func (*BatchCommandsEmptyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_cfafee8e4a43078c, []int{3}
}
...
func (*BatchCommandsEmptyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_cfafee8e4a43078c, []int{4}
}
...
type TikvClient interface {
	...
	RawPrintStats(ctx context.Context, in *kvrpcpb.RawPrintStatsRequest, opts ...grpc.CallOption) (*kvrpcpb.RawPrintStatsResponse, error)
...
func (c *tikvClient) RawPrintStats(ctx context.Context, in *kvrpcpb.RawPrintStatsRequest, opts ...grpc.CallOption) (*kvrpcpb.RawPrintStatsResponse, error) {
	out := new(kvrpcpb.RawPrintStatsResponse)
	err := c.cc.Invoke(ctx, "/tikvpb.Tikv/RawPrintStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TikvServer interface {
	...
	// Raw commands; no transaction support.
	RawPrintStats(context.Context, *kvrpcpb.RawPrintStatsRequest) (*kvrpcpb.RawPrintStatsResponse, error)
...
func _Tikv_RawPrintStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(kvrpcpb.RawPrintStatsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TikvServer).RawPrintStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tikvpb.Tikv/RawPrintStats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TikvServer).RawPrintStats(ctx, req.(*kvrpcpb.RawPrintStatsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Tikv_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RawPrintStats",
			Handler:    _Tikv_RawPrintStats_Handler,
		},
		{
			MethodName: "RawGet",
...
func (m *BatchCommandsRequest_Request_RawPrintStats) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.RawPrintStats != nil {
		dAtA[i] = 0xda
		i++
		dAtA[i] = 0x1
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawPrintStats.Size()))
		n30, err := m.RawPrintStats.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
...
func (m *BatchCommandsRequest_Request_CheckSecondaryLocks) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CheckSecondaryLocks != nil {
		...
		n31, err := m.CheckSecondaryLocks.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n31
...
func (m *BatchCommandsRequest_Request_RawCoprocessor) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawCoprocessor != nil {
		...
		n32, err := m.RawCoprocessor.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
...
func (m *BatchCommandsResponse_Response_RawPrintStats) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.RawPrintStats != nil {
		dAtA[i] = 0xda
		i++
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawPrintStats.Size()))
		n63, err := m.RawPrintStats.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n63
...
func (m *BatchCommandsResponse_Response_CheckSecondaryLocks) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CheckSecondaryLocks != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.CheckSecondaryLocks.Size()))
		n64, err := m.CheckSecondaryLocks.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n64
...
func (m *BatchCommandsResponse_Response_RawCoprocessor) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawCoprocessor != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawCoprocessor.Size()))
		n65, err := m.RawCoprocessor.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n65
...
func (m *BatchCommandsRequest_Request_RawPrintStats) Size() (n int) {
	var l int
	_ = l
	if m.RawPrintStats != nil {
		l = m.RawPrintStats.Size()
		n += 2 + l + sovTikvpb(uint64(l))
	}
	return n
}
...
func (m *BatchCommandsResponse_Response_RawPrintStats) Size() (n int) {
	var l int
	_ = l
	if m.RawPrintStats != nil {
		l = m.RawPrintStats.Size()
...
func (m *BatchCommandsRequest_Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RawPrintStats", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &kvrpcpb.RawPrintStatsRequest{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Cmd = &BatchCommandsRequest_Request_RawPrintStats{v}
			iNdEx = postIndex
		case 33:
			if wireType != 2 {
...
func (m *BatchCommandsResponse_Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 27:
			...
			v := &kvrpcpb.RawPrintStatsResponse{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Cmd = &BatchCommandsResponse_Response_RawPrintStats{v}
			iNdEx = postIndex
		case 33:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CheckSecondaryLocks", wireType)
...
func init() { proto.RegisterFile("tikvpb.proto", fileDescriptor_tikvpb_cfafee8e4a43078c) }

var fileDescriptor_tikvpb_cfafee8e4a43078c = []byte{
	// 2231 bytes of a gzipped FileDescriptorProto
	,
}
